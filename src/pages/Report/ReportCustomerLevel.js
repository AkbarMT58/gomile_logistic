...
import ReportCustomerLevelSpendingTable from 'components/Report/CustomerLevelSpending/ReportCustomerLevelSpendingTable';

const ReportCustomerLevel = () => {
  ...
  return (
    <Layout routes={SUBROUTES()} title="CRM">
      <Tooltip title="Refresh table" placement="right">
        <button
          className="my-4 bg-white w-64 p-2  rounded-md cursor-pointer text-center">
      ...
      />
      <ReportCustomerLevelSpendingTable
        dataTable={data}
        isLoading={isLoading}
        setUpdate={setUpdate}
        update={update}
...
export default ReportCustomerLevel;
