...
const MyTasksQuotation = () => {
  ...
  //   const params =
  //     `page=${page}&limit=${limit}&menu=ProductDevelopment&` +
  //     startParams +
  //     endParams +
  //     status +
  //     type +
  ...
  useEffect(() => {
    fetchData(date, setData, setIsLoading, page, limit, 'ProductDevelopment');
    ...
    <Layout routes={SUBROUTES(userOBE)} title="My Tasks">
      <Tooltip title="Refresh table" placement="right">
        <p
          ...
          onClick={() => fetchData(date, setData, setIsLoading, page, limit, 'ProductDevelopment')}>
          Quotation
        </p>
      </Tooltip>
      <FilterDate
...
export default MyTasksQuotation;
