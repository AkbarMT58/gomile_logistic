        ...
        <TableRow style={{ display: "flex" }}>
          ...
          >
            <div className="space-y-2 mx-3">
              <a
                href={`https://ocistok.co.id/control-panel/foto/${rowData.proof}`}
                download={rowData.proof}
                target="_blank"
                rel="noreferrer"
              >
                <button className="py-2 px-5 border text-blue-500  text-sm border-blue-500 rounded-md text-center w-full">
                  Download
                </button>
              </a>
