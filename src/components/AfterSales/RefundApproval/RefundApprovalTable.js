...
import CompletedAccountBankModal from './CompletedAccountBankModal';
        ...
        <TableRow style={{ display: 'flex' }}>
          ...
          <TableCell
            ...
            <div className="space-y-2 mx-3">
              {rowData.ready ? (
                <RefundApprovalModal rowData={rowData} setUpdate={setUpdate} />
              ) : (
                <CompletedAccountBankModal
                  idOrder={rowData.id_so}
                  idRefund={rowData.id_refund}
                  setUpdate={setUpdate}
                />
              )}
          ...
          <TableCell style={{ paddingBottom: 0, paddingTop: 0 }} colSpan={6}>
            <Collapse in={open} timeout="auto" unmountOnExit>
              <Box sx={{ margin: 1 }}>
                ...
                <DetailProductTable dataOrder={rowData.product} />
              </Box>
            </Collapse>
          </TableCell>
        </TableRow>
