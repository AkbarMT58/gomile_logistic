...
export default function NewOrderTable() {
  ...
  const sendPurchasing = async (id) => {
    ...
    const response = await send_purchasing(id)
            ...
            <div className="text-sm flex h-full flex-col justify-between">
              <div>
                ...
                {rowData?.idOrder?.mytask &&
                  <div className="px-2 py-1 text-xs text-white text-center bg-yellow-500 rounded-md mb-2">{rowData?.idOrder?.mytask}</div>
                }
            ...
            <div className="space-y-2 mx-3">
              ...
              {rowData?.idOrder?.toko === "1688" &&
                <div
                  ...
                  onClick={() => sendPurchasing(rowData.idOrder.id_so)}
                >
                  Order
                </div>
              }
