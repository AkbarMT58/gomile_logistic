...
export default function OtwWhChinaTable() {
  ...
  const fetchOrderData = async (limit, page, id) => {
    ...
    const data = await getOtwChinaData(params);
    if (data?.status === 200) {
      const newFormat = [];
            ...
            <div className="text-sm flex h-full flex-col justify-between">
              <div>
                ...
                <div>
                  ...
                  {rowData?.idOrder?.tracking_number && (
                    <p className="font-semibold">
                      RS : {rowData.idOrder.tracking_number}
                    </p>
                  )}
          ...
          <TableCell
            ...
            <div className="space-y-2 mx-3">
              ...
              <EditTracking
                ...
                trackingNumber={rowData.idOrder.tracking_number}
                setUpdate={setUpdate}
              />
              <Notes
                id={rowData?.idOrder?.id_so}
